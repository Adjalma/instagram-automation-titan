...
// describeIgTokenEnv removido — usar ENV diretamente
...
setTimeout(() => {
  // sdk.ensureAdminUser removido — admin criado via OAuth
  seedTriarcContent().catch(e => console.error("[Seed] Erro triac_content:", e));
  // seedContentThemes removido — temas gerenciados via UI
